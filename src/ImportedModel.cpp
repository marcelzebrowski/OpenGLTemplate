...
ImportedModel::ImportedModel(const char* filePath, const bool hasTexture) {
	init(filePath, hasTexture);
}

void ImportedModel::init(const char* filePath, const bool hasTexture) {
	ModelImporter modelImporter = ModelImporter();
	modelImporter.parseOBJ(filePath,hasTexture);
...
const bool ImportedModel::isTextured()
{
	return hasTexture;
}
...
void ModelImporter::parseOBJ(const char* filePath, const bool hasTexture) {
	float x, y, z;
	string content;
